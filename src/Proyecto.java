...
public class Proyecto {
	...
	private static int[] recogePosicion(String entrada) {
		int[] out = {-1, -1};
		if (entrada.length() >= 2) {
...
//si existe en otra posicion actualiza el precio al nuevo valor.
	private static boolean cambiarProducto(int[] posicion, String[] productos, int[][] tienda, int[] ventas, String producto) {
